...
import com.android.engineeringmode.gyroscopetest.WaveView;

import java.util.Calendar;

public class GyroscopeGraph extends ModelTest3ItemActivity {
            ...
            switch (msg.what) {
                case Light.MAIN_KEY_LIGHT /*1*/:
                    ...
                    if (GyroscopeGraph.this.xPassed == 3 && GyroscopeGraph.this.yPassed == 3 && GyroscopeGraph.this.zPassed == 3) {
                        ...
                        if (GyroscopeGraph.this.isInModelTest) {
                            GyroscopeGraph.this.onTestPassed();
                        }
                    }
