...
public class TriKeySwitchTest extends KeepScreenOnActivity implements TriKeySwitchChangedCallback {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        Log.d("TriKeySwitchTest", "onKeyDown KEY:" + keyCode);
        return true;
    }
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        Log.d("TriKeySwitchTest", "onKeyUp KEY:" + keyCode);
    ...
    private void initHashMap() {
        if (mIsOnePlus) {
            int[] keysToTest = new int[]{1000, 1001, 1002, 3, 4, 187};
            String[] keyValues = new String[]{"normal", "do_not_disturb", "mute", "home", "back", "app_switch"};
    ...
    private void initLayout() {
        ...
        for (Entry<Integer, String> entry : this.mKeyValues.entrySet()) {
            ...
            Log.d("TriKeySwitchTest", "initKeyTestLayout:" + entry.getKey());
            tv.setPadding(0, 0, 5, 0);
            tv.setText((CharSequence) entry.getValue());
            Log.d("TriKeySwitchTest", "initKeyTestLayout:" + ((String) entry.getValue()));
            layout.addView(tv);
            i++;
        }
    }
    ...
    public void onTriKeySwitchChanged(TriKeyMode type) {
        try {
            Log.d("TriKeySwitchTest", "onTriKeySwitchChanged:" + type);
            int TriKeyCode = 0;
