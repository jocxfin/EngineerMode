...
public class EarlyFabricationKeyTest extends KeepScreenOnActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mExitButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                EarlyFabricationKeyTest.this.finish();
            }
        });
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        Log.d("EarlyFabricationKeyTest", "onKeyDown KEY:" + keyCode);
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        Log.d("EarlyFabricationKeyTest", "onKeyUp KEY:" + keyCode);
        return true;
    }
    ...
    private void initHashMap() {
        ...
        if (isHasNavigationBar()) {
            keysToTest = new int[]{4, 187, 3};
            keyValues = new String[]{"back", "app_switch", "home"};
        } else {
            keysToTest = new int[]{4, 187, 3};
            keyValues = new String[]{"back", "app_switch", "home"};
        }
    ...
    private void initLayout() {
        ...
        for (Entry<Integer, String> entry : this.mKeyValues.entrySet()) {
            ...
            Log.d("EarlyFabricationKeyTest", "initKeyTestLayout:" + entry.getKey());
            tv.setPadding(0, 0, 5, 0);
            tv.setText((CharSequence) entry.getValue());
            Log.d("EarlyFabricationKeyTest", "initKeyTestLayout:" + ((String) entry.getValue()));
            layout.addView(tv);
            i++;
        }
    }
