...
public class FrontCameraTest extends AutoTestItemActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mPreview.setOnOpenCameraFailedListener(new OnOpenCameraFailedListener() {
            public void onFail() {
                Toast.makeText(FrontCameraTest.this, "Can't open the Camera", 1).show();
                FrontCameraTest.this.setAutoExit(1000);
            }
        });
