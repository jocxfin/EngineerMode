...
public class WifiSettings extends KeepScreenOnPreActivity implements OnClickListener, OnPreferenceChangeListener {
    ...
    private class Scanner extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (WifiSettings.this.mWifiManager.startScan()) {
                ...
                if (i >= 3) {
                    this.mRetry = 0;
                    Toast.makeText(WifiSettings.this, 2131296459, 1).show();
                    return;
                }
            }
            ProgressCategory - get0 = WifiSettings.this.mAccessPoints;
            if (this.mRetry == 0) {
                z = false;
            }
            -get0.setProgress(z);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("only_access_points", false)) {
            ...
            this.mPrefWifiStatus.setBtnDownloadClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if (WifiSettings.this.mDownloadManager.isDownloading()) {
                        Log.d("WifiSettings_EngineerMode", "onClick(), is downloading");
                        return;
                    }
                    WifiSettings.this.mDownloadManager.startDownloading();
                    WifiSettings.this.mPrefWifiStatus.setButtonDownloadEnable(false);
                }
            });
            ...
            this.mDownloadManager.setDownLoadPreference(this.mPrefWifiStatus);
        }
        ...
        this.mForgetListener = new ActionListener() {
            public void onSuccess() {
                Log.d("WifiSettings_EngineerMode", "forget network success");
                WifiSettings.this.updateAccessPoints();
                WifiSettings.this.saveNetworks();
            }

            public void onFailure(int reason) {
                Log.d("WifiSettings_EngineerMode", "forget network failed");
            }
        };
    }
    ...
    protected void onDestroy() {
        ...
        this.mPrefWifiStatus.unregisterChangeObserver();
        Log.e("WifiSettings_EngineerMode", "onDestroy");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, 7, 0, 2131296610).setIcon(17301633);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case Light.MAIN_KEY_LIGHT /*1*/:
                if (this.mWifiManager.isWifiEnabled() && !this.mHasScanned) {
            ...
            case Light.MAIN_KEY_NORMAL /*6*/:
                ...
                break;
            case 7:
                this.mDownloadManager.downLoadByBrowser();
                break;
        }
