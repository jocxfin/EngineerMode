...
public class WCDMANetworkSearch extends Activity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 100:
                    ...
                    WCDMANetworkSearch.this.mHandler.sendEmptyMessageDelayed(700, 1500);
                    return;
                case 500:
                    ...
                    WCDMANetworkSearch.this.mHandler.sendEmptyMessageDelayed(700, 100);
                    return;
                case 600:
                    if (((AsyncResult) msg.obj).exception != null) {
                    ...
                    WCDMANetworkSearch.this.finish();
                    return;
                case 700:
                    Log.e("NetworkSearch", "set G/W W preferred.");
                    WCDMANetworkSearch.this.mPhone.setPreferredNetworkType(2, WCDMANetworkSearch.this.mHandler.obtainMessage(600));
                    return;
                case 800:
                    if (((AsyncResult) msg.obj).exception != null) {
                    ...
                    WCDMANetworkSearch.this.mHandler.sendEmptyMessageDelayed(900, 500);
                    return;
                case 900:
                    Log.e("NetworkSearch", "send freq lock msg to modem");
                    WCDMANetworkSearch.this.mPhone.setBandMode(46, WCDMANetworkSearch.this.mHandler.obtainMessage(100));
                    return;
                default:
                    return;
            }
